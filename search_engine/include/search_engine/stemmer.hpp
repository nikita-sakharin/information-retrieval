...
private:
    ...
    static constexpr std::array<std::wstring_view, 62U> suffixes = {
        ...
        L"и", L"ии", L"ли", L"или", L"ами", L"ими", L"ыми", L"ями", L"ьями",
        L"й", L"ей", L"ий", L"ой", L"ый", L"л", L"ил", L"ам", L"ем", L"им",
        L"ом", L"ым", L"ям", L"ьям", L"ём", L"о", L"ого", L"ло", L"ило", L"у",
        L"ому", L"ах", L"их", L"ых", L"ях", L"иях", L"ы", L"ь", L"ившись",
